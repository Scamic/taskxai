...
export default function Task() {
  ...
  return (
    <div className="p-6 relative w-full h-screen mx-auto  mt-16 ">
...
<div className="bg-black/40 backdrop-blur-md max-w-6xl mx-auto p-4 rounded-2xl"> 
<motion.h1
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: [20, -5, 0] }}
        transition={{ duration: 0.5, ease: [0.4, 0.0, 0.2, 1] }}
        className="text-3xl font-bold mb-4 text-white  max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto px-4"
      >
        Task Manager{" "}
